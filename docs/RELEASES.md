...
- Automatic alignment now uses the committed OpenCV 5.0.0 CSP-safe ES module/Wasm build; only the hashed alignment Worker receives `'wasm-unsafe-eval'`, while the site remains free of `'unsafe-eval'`.
